          ...
          <div class="row mt-5 mb-5">
            <div class="col-md-12">
              <div class="link_account text-center">
                <h4 class=""><nuxt-link :to="{name:'account-register'}">Don't have account?</nuxt-link></h4>
                <nuxt-link :to="{name:'account-register'}" class="text_color"><b><u>Register Now?</u></b></nuxt-link>
              </div>
            ...
            <div class="row mt-5">
              <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="form-group">
                  <input v-model="form.emailOrPhone" type="text" class="form-control"
